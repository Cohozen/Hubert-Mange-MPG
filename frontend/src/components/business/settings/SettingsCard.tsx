...
/** Carte de réglages Broadcast : barre de dégradé + en-tête à barre verticale. */
export function SettingsCard({ bar, title, children }: { bar: string; title: string; children: ReactNode }) {
    return (
