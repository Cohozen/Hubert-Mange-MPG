...
export default function StatsPage() {
  ...
  const movements = useQuery({
    queryKey: ["movements"],
    queryFn: () =>
      api<{ promotions: Movement[]; relegations: Movement[]; yoyo: Movement[] }>(
        "/api/palmares/movements",
      ),
  });
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="text-xs opacity-60 mb-3">
          ...
          Europa · 🏵️ Conference) sont affichées à titre indicatif, hors calcul.
        </p>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        ...
                        {(() => {
                          ...
                          return c ? (
                            <>
                              {c.ldc > 0 && (
                                <span className="badge badge-sm badge-ghost">⭐ ×{c.ldc}</span>
                              )}
                              {c.uefa > 0 && (
                                <span className="badge badge-sm badge-ghost">🎖️ ×{c.uefa}</span>
                              )}
                              {c.conference > 0 && (
